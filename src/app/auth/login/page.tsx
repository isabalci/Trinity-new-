    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-gray-900 px-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600 dark:text-gray-400 mt-2">Ticaret platformuna hoş geldiniz</p>
        </div>
          ...
          <form className="space-y-6">
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="text-sm">
                <Link href="/auth/forgot-password" className="text-tradingview-blue hover:text-blue-700">
                  Şifremi unuttum
                </Link>
              </div>
            </div>
        ...
        <div className="text-center mt-6">
          <p className="text-gray-600 dark:text-gray-400">
            ...
            <Link href="/auth/register" className="text-tradingview-blue hover:text-blue-700 font-medium">
              Kaydol
            </Link>
          </p>
        </div>
