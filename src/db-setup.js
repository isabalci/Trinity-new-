/**
 * Trinity veritabanı kurulum script'i
 * Bu script, veritabanı tablolarını oluşturur ve örnek verileri ekler
 */
...
const dbConfig = {
  ...
  host: 'localhost',
  database: 'trinity_db',
  password: '107040', // Gerçek projede bu değer çevre değişkenlerinden alınmalıdır
  port: 5432
};

// SQL dosyasını oku
const dbSetupSql = fs.readFileSync(path.join(__dirname, '../db_setup.sql'), 'utf8');
...
async function setupDatabase() {
  ...
  try {
    ...
    console.log('Örnek piyasa verileri eklendi');
    ...
    console.log('Örnek haber verileri eklendi');
    
    // Örnek grafik verileri ekle
    const now = new Date();
    ...
    console.log('Örnek grafik verileri eklendi');
